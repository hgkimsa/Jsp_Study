...
<%
    ...
    Integer nowpageObj = (Integer) request.getAttribute("page");
    
    int num = (numObj != null) ? numObj.intValue() : 0;
    int nowpage = (nowpageObj != null) ? nowpageObj.intValue() : 1;
%>
<html>
<head>
...
<body>
    ...
    <div class="container">
        ...
        <% } else { %>
        <p>게시글을 찾을 수 없습니다.</p>
        <a href="./BoardListAction.do?pageNum=1" class="btn btn-primary">목록으로 돌아가기</a>
        <% } %>
        <hr>
    </div>
